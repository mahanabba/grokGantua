...
def generate_story(prompt):
    ...
    try:
        messages = [
            {
                "role": "system", 
                "content": "You are a highly intelligent AI story generator that creates engaging, interactive 'Choose Your Own Adventure' narratives. At the end of each post you end with 3 options labeled Option 1: Option 2: Option 3: for polling reasons. these options MUST be less than 25 characters. Do not mention word count in the post."
            },
...
def main():
    ...
    prompt = (
        ...
        "End with three numbered choices labeled 'Option 1:', 'Option 2:' and 'Option 3:' for X's next move. a poll option can never be more than 25 characters. the options 1 2 and 3 can not be over 25 characters long. use one word if needed. do NOT post the word count in the story, stick to the narrative"
    )
